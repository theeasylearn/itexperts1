 ...
 * Slug: fse-business-blocks/general-boxes-two-contrast-background
 * Categories: featured
 */
?>
...
<h3 class="wp-block-heading has-x-large-font-size" id="sample-heading-1"><?php echo esc_html__( 'Build with FSE Business Blocks', 'fse-business-blocks' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p><?php echo esc_html__( 'FSE Business Blocks is a powerful WordPress theme created for agencies and professional website builders. With its clean, minimal design, FSE Business Blocks provides the perfect canvas for stylish and sophisticated websites.', 'fse-business-blocks' ); ?></p>
<!-- /wp:paragraph -->
<!-- wp:buttons -->
<div class="wp-block-buttons"><!-- wp:button -->
<div class="wp-block-button"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Learn More', 'fse-business-blocks' ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:column -->
