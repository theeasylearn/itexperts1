 ...
 * Slug: fse-business-blocks/footer-stacked
 * Categories: footer
...
<p class="has-text-align-center has-small-font-size">© 2023 Your Company LLC · <a href="#"><?php echo esc_html__( 'Contact Us', 'fse-business-blocks' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
